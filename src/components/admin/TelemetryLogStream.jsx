              ...
              telemetryLogs.map(log => {
                ...
                return (
                  <tr key={log.id} className={`hover:${theme.secondary} transition-colors`}>
                    <td className={`p-3 whitespace-nowrap ${_subText}`}>{new Date(log.created_at).toLocaleTimeString()}</td>
                    <td className="p-3 whitespace-nowrap">
                      {data.username ? (
                        ...
                        <span className={`italic ${_subText}`}>Anonymous</span>
                      )}
                    </td>
                    ...
                    <td className="p-3 text-center font-bold text-amber-500">
                      {data.max_wpm !== undefined ? `${data.max_wpm}` : '-'}
                    </td>
                    <td className="p-3 text-center font-bold text-indigo-500">
                      {data.avg_wpm !== undefined ? `${data.avg_wpm}` : '-'}
                    </td>
